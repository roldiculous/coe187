...
# Training Script for Cats vs Dogs / RPS
python train.py --epochs 50 --optimizer Adam --lr 0.001 --wd 0 --deterministic --compress policies/schedule-rps.yaml --model ai85rpsnet --dataset rock_paper_scissors --confusion --param-hist --embedding --enable-tensorboard --device MAX78000 "$@"
